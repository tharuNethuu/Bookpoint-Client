...
const Login = () => {
  ...
  return (
    ...
    <div className="relative h-70 w-full sm:h-96 lg:h-full lg:w-1/2">
     <img
       alt=""
       src="https://i.imgur.com/RUJXWIk.jpeg"
   ...
   <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24 bg-black">
     ...
     {alertVisible && (
       ...
       <h1 className="text-2xl text-yellow-300 font-bold sm:text-4xl">Welcome to Neth BookPoint!</h1>
       ...
       <p className='text-yellow-500 font-semibold text-xl'>Login to Your Account!</p>
     </div>
...
Don't you have an account?<Link to='/sign-up' className='text-yellow-700 hover:text-yellow-200'> Create an account</Link>
<hr/>
 <div>
   <button onClick={handleRegister} className='block py-2 text-white font-light hover:text-yellow-400'><img src="https://static.vecteezy.com/system/resources/previews/021/496/096/original/google-symbol-logo-design-illustration-with-black-background-free-vector.jpg" className='w-10 inline-block'/>Login with Google</button>
 </div> 
