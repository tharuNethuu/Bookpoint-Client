...
const FavBook = () => {
  return (
    <div className='bg-black px-4 lg:px-24  text-white flex flex-col md:flex-row justify-between items-center gap-12 md:py-5'>
...
<div className='md:w-1/2 space-y-6  '>
    <h2 className='text-5xl text-white font-bold  wd:3/4 leading-snug'>Your favourite
    <span className='text-yellow-600'> Reads Are Here!</span></h2>
...
{/*stats*/}
<div className=' text-yellow-100 flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 '>
    <div >
    ...
    <Link to="/shop" className='mt-8 block'><button className='bg-yellow-700 text-white font-semibold px-5 py-2 rounded hover:bg-yellow-500 transition-all duration-300 md:mb-5'>
