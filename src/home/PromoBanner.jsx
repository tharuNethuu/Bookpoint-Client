...
<p className=' text-yellow-500 text-xs'>*Discount conditions apply.</p>
        ...
        <Link to="/AwardBooks" className='mt-8 block'><button className='bg-yellow-600 text-white font-semibold px-5 py-2 rounded hover:bg-yellow-900 transition-all duration-300'>
