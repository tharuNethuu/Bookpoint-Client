...
export default function CheckoutBtn({ wishListBooks, copies, totalPrice }) {
  ...
  return (
    <div>
      <Popup trigger={<button className='text-white font-semibold text-xl bg-red-950 rounded-full hover:bg-red-500 transition-all duration-300 py-2 px-10'> Proceed to Checkout </button>} modal nested>
        {close => (
          <div className='modal rounded-2xl mt-20 '>
            <div className='content rounded-2xl bg-black py-5 overflow-y-auto max-h-[80vh]'>
              <div className=' bg-black w-full px-5 rounded-2xl'>
                <h3 className=' font-semibold text-2xl text-yellow-400 text-center py-5'>Checkout Details</h3>
                {alertVisible && (
        <Alert message={alertMessage} variant={alertVariant} onClose={() => setAlertVisible(false)} />
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                  ...
                  <FaUser className='text-white mr-2' />
                    <label className='block text-white mb-1'>  Receiver Name</label>
                    </div>
                    <input
                      type="text"
                      value={receiverName}
                  ...
                  <FaAddressBook className='text-white mr-2' />
                    <label className='block text-white mb-1'>Billing Address</label>
                    </div>
                    <input
                      type="text"
                  ...
                  <FaMapMarkerAlt className='text-white mr-2' />
                    <label className='block text-white mb-1'>Sending Address</label>
                    </div>                    <input
                      type="text"
                  ...
                  <button
                    ...
                    className="text-white font-semibold  bg-red-950 rounded-full hover:bg-red-500 transition-all duration-300 py-2"
                  >
                    PAY NOW
                  </button>
                  <button
                    onClick={() => close()}
                    className="text-white  bg-red-950 rounded-full hover:bg-red-500 transition-all duration-300 py-2"
                  >
                    Close Checkout Page
                  </button>
                </div>
